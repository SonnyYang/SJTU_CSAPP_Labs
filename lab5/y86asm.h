...
//have added TYPE_LAB in type_t
//in order to deal with the case of a line with both label and inst
...
typedef enum{ TYPE_COMM, TYPE_INS, TYPE_ERR , TYPE_LAB} type_t;
